...
tab2_demo_uk <- odbc::dbGetQuery(con, 
  "SELECT 
   SUM(CASE WHEN GENDER = 'U' THEN 1 ELSE 0 END) as GENDER,
...
tab2_enc_uk <- odbc::dbGetQuery(con, 
  "SELECT SUM(CASE WHEN PROVIDER = 'UKNOWN' THEN 1 ELSE 0 END) as PROVIDER
      FROM ENCOUNTERS")
...
## Table 2. Top 5 Patient Primary Languages
...
##Table 5 . Count of Distinct Patients by Age Group and Year of Utilization
