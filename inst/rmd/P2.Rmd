...
params: 
    DBServerName: 
        ...
        input: select
        choices: [cc-s-d05.ucdenver.pvt, cc-s-d05.ucdenver.pvt, cc-s-d05.ucdenver.pvt, cc-s-d05.ucdenver.pvt]
    DBName:
        label: "Database Name:"
        value: VDW_3_1_DH
        input: select
        choices: [VDW_3_1_DH, VDW_3_1_DH, VDW_3_1_DH, VDW_3_1_DH]
---
...
kable(tab6_all, col.names = c("Year", "Total Number of Prescriptioins", "Percent Change From Last Year", "Total Number of Patients", "Median number of Prescriptioins per patient", "Minimum Number of Prescriptioins Per Patient", "Maximum Number of Prescriptioins Per Patient"), format.args = list(big.mark = ","))
...
tab16 <- odbc::dbGetQuery(con, 
  "select year(contact_date) as year,
   count(*) as num_rec,
   SUM(CASE WHEN TOBACCO_USER = 'Y' THEN 1 ELSE 0 END) as alc_use,
   SUM(CASE WHEN TOBACCO_USER = 'Q' THEN 1 ELSE 0 END) as former,
   SUM(CASE WHEN TOBACCO_USER = 'N' THEN 1 ELSE 0 END) as never,
   SUM(CASE WHEN TOBACCO_USER IN ('X', 'U') THEN 1 ELSE 0 END) as unknown,
   SUM(CASE WHEN TOBACCO_USER IS NULL THEN 1 ELSE 0 END) as t_null
...
tab17 <- odbc::dbGetQuery(con, 
  "select year(contact_date) as year,
   count(*) as num_rec,
   SUM(CASE WHEN TOBACCO_USER = 'Y' THEN 1 ELSE 0 END) as ill_drug,
   SUM(CASE WHEN TOBACCO_USER = 'Q' THEN 1 ELSE 0 END) as former,
   SUM(CASE WHEN TOBACCO_USER = 'N' THEN 1 ELSE 0 END) as never,
   SUM(CASE WHEN TOBACCO_USER IN ('X', 'U') THEN 1 ELSE 0 END) as unknown,
   SUM(CASE WHEN TOBACCO_USER IS NULL THEN 1 ELSE 0 END) as t_null
